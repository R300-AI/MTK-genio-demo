...
output_handlers_with_shape = {'output0.bin': (1, 1, 84, 8400)}   # you can use the 'sudo neuronrt -a yolov8n_float32.dla -d' cammand to check the number of output handlers needed.
image_path = './bus.jpg'
